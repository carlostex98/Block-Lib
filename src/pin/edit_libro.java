 ...
 * @author ccten
 */
public class edit_libro extends javax.swing.JFrame {

    /**
     * Creates new form edit_libro
     */
    isb actual;

    public edit_libro(isb n) {
        initComponents();
        isbn.setText(Integer.toString(n.isbn));
        anio.setText(Integer.toString(n.anio));
        titulo.setText(n.titulo);
        categoria.setText(n.categoria);
        editorial.setText(n.editorial);
        edicion.setText(n.edicion);
        idioma.setText(n.idioma);
        autor.setText(n.autor);
        actual = n;
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!is_numeric(isbn.getText())) {
            ...
            if (!is_numeric(anio.getText())) {
                ...
                if (Integer.toString(actual.isbn).equals(isbn.getText())) {
                    //si el isbn es igual
                    if (categoria.getText().equals(mains.cat_curr.nombre)) {
                        //si la categoria sigue siendo la misma
                        mains.libro_aux.edit(Integer.parseInt(isbn.getText()), titulo.getText(), autor.getText(), editorial.getText(), Integer.parseInt(anio.getText()), edicion.getText(), mains.cat_curr.nombre, idioma.getText(), mains.nop.carnet);
                    } else {
                        //si la categoria no es igual
                        //nada porque el enunciado no lo pide jajajajaj
                    }
                } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(edit_libro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new edit_libro(null).setVisible(true);
            }
        });
    }
