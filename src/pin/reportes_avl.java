 ...
 * @author ccten
 */
public class reportes_avl extends javax.swing.JFrame {

    /**
     * Creates new form reportes_avl
     */
    public reportes_avl() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(reportes_avl.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new reportes_avl().setVisible(true);
            }
        });
    }
